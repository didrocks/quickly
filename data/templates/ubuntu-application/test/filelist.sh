...
# test_project_quickly/
# test_project_quickly/BaseAboutTestProjectDialog.py
# test_project_quickly/BasePreferencesTestProjectDialog.py
# test_project_quickly/BaseTestProjectWindow.py
# test_project_quickly/Builder.py
# test_project_quickly/__init__.py
# test_project_quickly/helpers.py
# test_project_quickly/preferences.py
# test_project_quickly/test_projectconfig.py
