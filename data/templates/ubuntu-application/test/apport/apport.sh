...
grep LaunchpadIntegration. test_project_quickly/BaseTestProjectWindow.py
#             LaunchpadIntegration.add_items(self.ui.helpMenu, 1, False, True)
#             LaunchpadIntegration.set_sourcepackagename('test-project')

grep helpMenu test_project_quickly/BaseTestProjectWindow.py
#             LaunchpadIntegration.add_items(self.ui.helpMenu, 1, False, True)
...
cp "$TEST_SCRIPT_DIR/BaseTestProjectWindow.py.no_lpi" ./test_project_quickly/BaseTestProjectWindow.py
...
# modified test_project_quickly/BaseTestProjectWindow.py
