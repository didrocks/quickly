...
LPI_init_menu_block = """
        ...
        try:
            ...
            LaunchpadIntegration.add_items(self.ui.%(help_menu)s, 1, False, True)
...
def insert_lpi_if_required(project_name):
    ...
    existing_base_filename = os.path.join(quickly.templatetools.python_name(project_name) + '_quickly',
