...
#set up the game over screen, center is by default
gov = BaseSprite(python_name.python_nameconfig.game_over_background)
gov.x = (sw - gov.rect.width)/2
gov.y = (sh - gov.rect.height)/2
gov.update()
...
def view_tick():
    ...
    if game.lives < 1:
        screen.blit(gov.image,gov.rect)
