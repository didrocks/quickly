...
# add commands configure create debug design edit getstarted help license package quickly release run save share tutorial upgrade
...
quickly shell-completion quickly foo
# add commands configure debug design edit getstarted help license package quickly release run save share tutorial upgrade
